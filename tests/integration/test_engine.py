...
from repositories import user_repository, content_repository, skill_repository
...
def test_recommendation_evaluator():
    ...
    # NDCG@2: hits at index 1 -> DCG = 1/log2(3) = 0.6309. IDCG@2 = 1 + 1/log2(3) -> NDCG = DCG/IDCG
